...
include_once "../../../classes/simplediff.php";
include_once "../../../classes/modules/htmldiff/html_diff.php";
    		...
    		<table border = "2">
				...
				<?php
					...
					foreach ($updatedObjList as &$updatedObj) {
						$oldObj = BLL_data_objects::Select_DataObjects_ByGuid('slave', $updatedObj->guid, $updatedObj->data_type_id);
    			...
    			<tr>
    				...
    				<td style="width:300px">
    					<? if(strcmp(Text_Compare::clean_string($oldObj[0]->description), Text_Compare::clean_string($updatedObj->description))<>0)
    					 	echo Text_Compare::compare_objects($oldObj[0]->description, $updatedObj->description);?>
    				</td>
    				<td style="width:300px">
    					<? if(strcmp(Text_Compare::clean_string($oldObj[0]->description), Text_Compare::clean_string($updatedObj->description))<>0)
    					 	echo Text_Compare::htmlDiff($oldObj[0]->description, $updatedObj->description);?>
    				</td>
    				<td style="width:300px">
    					<? if(strcmp(Text_Compare::clean_string($oldObj[0]->description), Text_Compare::clean_string($updatedObj->description))<>0)
    					 	echo html_diff($oldObj[0]->description, $updatedObj->description);?>
    				</td>
    			</tr>		
