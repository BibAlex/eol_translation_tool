...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`172.16.0.200`*/ /*!50003 TRIGGER DO_Insert Before insert on data_objects
  FOR EACH ROW BEGIN   
...
/*!50013 DEFINER=`root`@`172.16.0.200` SQL SECURITY DEFINER */
